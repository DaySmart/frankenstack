				...
				deciderCellsThatCareAboutMe: [
                    ...
                    filters.TOP_1_WHERE_ENTITY_EQUALS_AND_TYPE_EQUALS_AND_ENTITYID_IN_LIST_FROM_FUNCTION,
									filterValues: [
										...
										(observation) =>
											observation.data.Components.map((component) => `${observation.data.DeploymentGuid}:${observation.data.Env}:${component.Name}`),
									],
								},
								{
									filter:
				...
				deciderCellsThatCareAboutMe: [
                    ...
                    filters.TOP_1_WHERE_ENTITY_EQUALS_AND_TYPE_EQUALS_AND_ENTITYID_IN_LIST_FROM_FUNCTION,
									filterValues: [
										...
										Component.TYPE,
										(observation) =>
											observation.data.Components.map((component) => `${observation.data.Env}:${component.Name}`),
									],
								},
								{
									filter:
