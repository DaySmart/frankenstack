...
export class LambdaDeciderModuleInstance extends LambdaDeciderModule {
  constructor(
    ...
    this.functionName = process.env.DECIDER_LAMBDA_FUNCTION_NAME ? process.env.DECIDER_LAMBDA_FUNCTION_NAME : "Function name not found";
