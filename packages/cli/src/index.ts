...
// Updated typing: NodeJS.Global has been removed from newer @types/node versions.
// Use globalThis intersection to safely add WebSocket for runtime assignment.
type CustomNodeJsGlobal = typeof globalThis & { WebSocket: any };
