...
import {
  DeploymentUpdateMutationVariables,
  InputComponent,
  PutPolicyMutationVariables,
  PutUserMutationVariables,
...
import {
  getComponentRollbackStateFull,
  describeComponentFull,
  getDeploymentRequestFull,
...
export class EnvironmentServiceAppSyncClient {
  ...
  async sendDeploymentForm(
    deploymentGuid: string,
    deploymentForm: Template
  ): Promise<FetchResult> {
  ...
  async deploymentUpdate(
    deploymentUpdateMutation: DeploymentUpdateMutationVariables
  ): Promise<FetchResult> {
    return await this.client.mutate({
  ...
  async removeComponent(
    mutation: RemoveComponentMutationVariables
  ): Promise<FetchResult> {
    return await this.client.mutate({
  ...
  subscribeToDeploymentUpdate(
    deploymentGuid: string
  ): ReturnType<AWSAppSyncClient<any>["subscribe"]> {
